...
def background_test_runner():
    ...
    try:
        ...
        test_result_message = "[green]🧪 Запуск тестов... OK ✔️[/green]"
    except Exception as e:
        # Если есть ошибки, выводим их сразу
        console.print(f"[bold red]Обнаружены ошибки при тестировании: {e}[/bold red]")
